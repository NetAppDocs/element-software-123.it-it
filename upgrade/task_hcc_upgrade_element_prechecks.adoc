...
È possibile eseguire i controlli dello stato di salute utilizzando l'interfaccia utente di NetApp Hybrid Cloud Control, l'API di NetApp Hybrid Cloud Control o la suite HealthTools:
