...
summary: 'È possibile risincronizzare il volume di origine originale e eseguire un failback utilizzando l"interfaccia utente di NetApp Element. Questa procedura si applica agli scenari in cui il volume di origine originale esiste ancora.' 
---
