...
Stage4BlockThresholdByte
 a| 
Il numero di byte di storage utilizzati dal cluster in cui si verifica una condizione di fullness fase 4.
 a| 
intero
...
Stage4MetadataThresholdBytes
 a| 
Il numero di byte di metadati utilizzati dal cluster in cui si verifica una condizione di fullness della fase 4.
 a| 
...
Stage5MetadataThresholdBytes
 a| 
Il numero di byte di metadati utilizzati dal cluster in cui si verifica una condizione di fullness della fase 5.
 a| 
